...
export default class UpdateSingerPage extends React.Component<IProps, IState> {
    ...
    render() {
        const { Id, FirstName, LastName, Nationality, About, Image } = this.state;
        return (
            <div className="col-md-12 col-sm-12 mb-12">
                <PageHeader title="Atualizar Artista" subtitle="FreeTone" link="/singers" />
